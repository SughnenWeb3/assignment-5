...
if command not in ["login", "register", "exit"]:
    ...
    if username in database:
        ...
        verification = input("Do you want to verify your account?: ").lower()
        if verification == "yes" or verification == "y":
            if initial_amount > verification_fee:
                initial_amount -= verification_fee
                database[username]["is_verified"] = True
                database[username]["initial_amount"] = initial_amount
                print("\nAccount verified successfully")
            else:
                print("Insufficient balance")
        elif verification == "no" or verification == "n":
            print("You can choose to verify your account later")
        print(database)
